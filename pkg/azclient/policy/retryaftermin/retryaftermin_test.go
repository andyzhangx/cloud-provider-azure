...
// TestRetryAfterMinPolicy tests RetryAfterMinPolicy functionality
...
// TestNewRetryAfterMinPolicy tests the creation of RetryAfterMinPolicy
func TestNewRetryAfterMinPolicy(t *testing.T) {
	...
	retryPolicy, ok := policy.(*retryaftermin.RetryAfterMinPolicy)
	assert.True(t, ok)
